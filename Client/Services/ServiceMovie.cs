    ...
    public class ServiceMovie: IServiceMovie 
    {
        public List<Movie>GetMovies(){
            return new List<Movie>(){
                ...
                new Movie(){MovieName="Vanguard ", Image="Images/Movie1.jpg", Genre="Genero: Acción ", Synopsis="trama", Raiting = "Calificación: 4.5", MovieReleaseDate=new DateTime(2021,09,26)},
                new Movie(){MovieName="Free Guy", Image="Images/Movie1.jpg", Genre="Genero: Comedia ", Synopsis="trama", Raiting = "Calificación: 4.5", MovieReleaseDate=new DateTime(2021,09,26)},
                new Movie(){MovieName="Duro de cuidar 2", Image="Images/Movie1.jpg", Genre="Genero: Acción/comedia ", Synopsis="trama", Raiting = "Calificación: 4.5", MovieReleaseDate=new DateTime(2021,09,26)},
